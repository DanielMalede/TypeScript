...
//     kosher: boolean
//     constructor(nameOfFactorry: string, city: string, numOfWorkers: number, approved: boolean, kosher: boolean) {
//         super(nameOfFactorry, city, numOfWorkers, approved)
//         this.kosher = kosher
//     }
//     getSandwichInfo() {
//         return `${this.getDetails}kosher?: ${this.kosher}`
//     }
//     chackIfThereIsAutomation() {
